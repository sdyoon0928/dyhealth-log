...
| 배포 주소 | http://43.203.239.235:4923 |
...
설치 없이 아래 주소에서 사용할 수 있습니다.

| 주소 | 내용 |
|---|---|
| http://고정IP:4923 | 웹 화면 (회원가입 후 이용) |
| http://고정IP:4923/docs | Swagger 자동 문서 |

> AWS Lightsail(Ubuntu 22.04)에서 Docker Compose로 실행 중입니다.
> 학습용 프로젝트이므로 HTTPS는 적용되어 있지 않습니다.
